...
def main():
    FPS = 60
    window = Window("Pendulum", 1200, 800, fps= FPS) # Initialize new window with dimensions 1200x800
    ...
    window.add_update_function(lambda: pendulum.update(type = 2, fps = FPS)) # Appends pendulum function to updates variables using type 1 or 2 update function
